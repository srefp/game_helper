...
; 路线
global routes := [
;    {monster: [8, 3], pos: [1403, 576]}, ; 1
    {monster: [8, 3], pos: [1071, 539]}, ; 2
    {monster: [8, 3], pos: [977, 649]}, ; 3
    {monster: [3, 1], pos: [1120, 1006], movY: -200}, ; 4
    {monster: [3, 1], pos: [1042, 1026], selectX: twoSelection}, ; 5
