...
; 路线
global routes := [
    {row: 8, column: 3, x: 1403, y: 576, crusade: true}, ; 1
    {row: 8, column: 3, x: 1071, y: 539}, ; 2
    {row: 8, column: 3, x: 977, y: 649}, ; 3
    {row: 3, column: 1, movY: -200, x: 1120, y: 1006}, ; 4
    {row: 3, column: 1, x: 1042, y: 1026, selectX: 1321, selectY: 731}, ; 5
